...
- image_concept: ONE sentence in English describing a symbolic, text-free visual scene for the story's editorial illustration — physical objects, shapes, and composition only. Never mention words, letters, numbers, text, signs, logos, or readable documents in the scene. Nothing graphic: no blood, injuries, bodies or aimed weapons. Example: for a story about student visa time limits — "An hourglass suspended above a graduation cap, sand falling in a thin stream."
- image_alt_es: ONE sentence in SPANISH, max 200 chars, describing that same scene the way a reader will see it in the finished drawing; it becomes the image's alt text. Example: "Un reloj de arena suspendido sobre un birrete, con la arena cayendo en un hilo fino."
- image_url: null
